...
values <- qw(GSTseq, NumberCollected, ExactMatches, InexactMatches, MatchedSeq, ensembl.gene.id,gene.strand, gene.start.position, gene.end.position, peak.inside.gene, distance.to.gene, mgi.symbol, description  )
