...
big.clusters <- nearest[as.numeric(nearest[,"Cluster.Overlap.Count"])>100,]

#> big.clusters[,"Target"]
# [1] "Lrrc4c"        "Lrrc4c"        "Lrrc4c"        "Lrrc4c"       
# [5] "Stmn2"         "Tm4sf1"        "Tmem68"        "Cdk5rap2"     
# [9] "6330530A05Rik" "Rpl26"         "Cdk8"          "BC031151"     
#[13] "Chl1"          "4930433N12Rik" "4930433N12Rik" "4930433N12Rik"
#[17] "4930433N12Rik" "4930433N12Rik" "Rpusd4"        "9230019H11Rik"
#[21] "Raet1a"        "Axin2"         "Mamdc1"        "Kcnh5"        
#[25] "Chrm3"         "BC055107"      "LOC432825"     "Sh2d4b"       
#[29] "Ly6c"          "Zc3h7a"        "Pgk2"          "Crem"         
#[33] "AK013700"      "4930428D18Rik" "Pak3"    




# try some ontology analysis on the genes close to the peaks?
# Actualy, geometric test isn't really what we want. can't we
# corrolate distance to tss with ontology term?
